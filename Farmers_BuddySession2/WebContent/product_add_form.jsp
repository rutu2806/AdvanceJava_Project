...
<body>
    <spr:form action="product_add.htm" method="get" commandName="product">
        ...
        <div class="container-fluid">
            ...
            <div class="row bg-dark"
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td align="center">
                                    <button class="btn btn-light px-4" type="submit">ADD</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="col-12">
                <button class="btn btn-block py-3" style="font-size: 25px;">
                <a href="product_list.htm">Product List</a>
                </button>
                </div>
            </div>
